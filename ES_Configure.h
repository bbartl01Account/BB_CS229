...
#define SERV_0_HEADER "CLCService.h"
// the name of the Init function
#define SERV_0_INIT InitCLCService
// the name of the run function
#define SERV_0_RUN RunCLCService
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "BarLEDService.h"
// the name of the Init function
#define SERV_1_INIT InitBarLEDService
// the name of the run function
#define SERV_1_RUN RunBarLEDService
// How big should this services Queue be?
...
#define TIMER13_RESP_FUNC PostCLCService
#define TIMER14_RESP_FUNC PostBarLEDService
#define TIMER15_RESP_FUNC PostCLCService
